...
- **Nothing serves your passwords.** The window asks the backend one command at a time, and
  ...
  you set a passphrase, a key agent that holds the derived key on a socket in your private
  runtime directory (`$XDG_RUNTIME_DIR`, mode 0700) and forgets it after an idle timeout.
